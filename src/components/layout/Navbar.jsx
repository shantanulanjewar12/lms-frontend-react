...
export default function Navbar() {
  ...
  return (
    <nav
      ...
      style={{
        background:
          scrolled || !isAuthenticated ? "var(--bg-glass)" : "transparent",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2" ref={ref}>
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="relative">
                  ...
                  {notifOpen && (
                    <div
                      className="absolute right-0 mt-2 w-80 rounded-2xl overflow-hidden animate-fade-up"
                      style={{
                ...
                {profileOpen && (
                  <div
                    className="absolute right-4 top-16 w-60 rounded-2xl overflow-hidden animate-fade-up z-50"
                    style={{
                      background: "var(--bg-card)",
                      border: "1px solid var(--border)",
                      boxShadow: "var(--shadow-lg)",
                  ...
                  >
                    ...
                    <div className="p-2">
                      ...
                      >
                        ...
                        {unreadCount > 0 && (
                          <span
                            className="ml-auto w-5 h-5 rounded-full text-white flex items-center justify-center"
                            style={{
                              background: "var(--brand)",
                              fontSize: "0.6rem",
                              fontWeight: 700,
            ...
            {/* Mobile toggle */}
            <button
              className="md:hidden btn-ghost w-10 h-10 rounded-xl flex items-center justify-center"
        ...
        {mobileOpen && (
          <div
            className="md:hidden py-4 animate-fade-up"
            ...
            {!isAuthenticated && (
              <div className="flex gap-2 mt-3 px-4">
                <Link to="/login" className="flex-1">
                  <button className="btn-outline w-full px-4 py-2 rounded-xl text-sm">
                    Sign In
                  </button>
                </Link>
              </div>
